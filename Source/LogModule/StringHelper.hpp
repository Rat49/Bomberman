...
namespace StringHelper {
	...
	inline std::string ToString(int32_t x) { return std::to_string(x); };
	inline std::string ToString(uint32_t x) { return std::to_string(x); };
	inline std::string ToString(int64_t x) { return std::to_string(x); };
	inline std::string ToString(uint64_t x) { return std::to_string(x); };
