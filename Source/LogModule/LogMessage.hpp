...
public:
	...
	const std::string GetText() const override { return mText; };
	const LogLevel GetLevel() const override { return mLogLevel; };
	const LogChannel GetChannel() const override { return mLogChannel; };
