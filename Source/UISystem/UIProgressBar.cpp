...
UIProgressBar::UIProgressBar(const sf::Vector2f& newSize, float newMinValue, float newMaxValue) : minValue(newMinValue), maxValue(newMaxValue), currentValue(minValue)
{
	setSize(newSize);
