...
public:
    ...
    //event handlers
    virtual bool BeginOverlapHandler(void*)
    {
        return false;
    };
    ...
    void setRectangle(const sf::RectangleShape& sfRectangle)
    {
        this->rectangle = sfRectangle;
    }

    // Getter for overlapping
    const bool getIsOverlapped() const
    {
        return isOverlapped;
    }

    // Setter for overlapping
    void setIsOverlapped(bool overlap)
    {
        isOverlapped = overlap;
    }
    ...
    CollisionObject* getObjectParent() const
    {
        return parent;
    }

    // Setter for the parent
    void setParent(void* nParent)
    {
        this->parentComponent = nParent;
    }

    void setObjectParent(CollisionObject* newParent)
    {
        parent = newParent;
    }
