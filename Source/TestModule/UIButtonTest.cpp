...
void UIButtonTest::setup()
{
    ...
    // Set onHover event
    button->onHover = []() { LOG("UIButton is hovered!"); };

    // Set onClick event
    button->onClick = []() { LOG("UIButton was clicked!"); };

    button2->onHover = []() { LOG("UIButton is hovered!"); };

    button2->onClick = []() { LOG("UIButton was clicked!"); };

    button3->onHover = []() { LOG("UIButton is hovered!"); };

    button3->onClick = []() { LOG("UIButton was clicked!"); };

    button4->onHover = []() { LOG("UIButton is hovered!"); };

    button4->onClick = []() { LOG("UIButton was clicked!"); };
}
